...
class AlternativeController extends Controller
{
    public function index(){
        ...
        return view('pages.alternative', compact('alternatives'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('pages.alternatives')->with('toast_success', 'Alternatif '.$request->name.' ditambahkan!');
    }

    public function delete(Request $request){
        $alternative = Alternative::find($request->id);
        $alternative->delete();
        return redirect()->route('pages.alternatives')->with('toast_success', 'Alternatif '.$alternative->name.' dihapus!');
    }
    ...
    public function update(Request $request){
        ...
        return redirect()->route('pages.alternatives')->with('toast_success', 'Alternatif '.$request->name.' diperbarui!');
    }
}
