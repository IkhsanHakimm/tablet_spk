...
class CalculationController extends Controller
{
    public function index(){
        ...
        return view('pages.calculation', compact('decisionMatrix', 'normMatrix', 'weightedNorm', 'idealPositive', 'idealNegative', 'solutionPositive', 'solutionNegative', 'PreferenceValue', 'criteria', 'alternatives'));
    }
